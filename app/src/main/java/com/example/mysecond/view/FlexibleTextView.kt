package com.example.mysecond.view
...
class FlexibleTextView : androidx.appcompat.widget.AppCompatTextView {
    ...
    protected fun getScaleListener(): ScaleGestureDetector.SimpleOnScaleGestureListener? {
    ...
    override fun onTouchEvent(ev: MotionEvent): Boolean {
        ...
        val firstCoords = MotionEvent.PointerCoords()
